...
# 显存占用相关
MODEL_PATH=expt/rl_cold_start/pdtb2/top/qwen3-1.7b/epo1/lora_merged
train_prompt_bsz=16
...
actor_ppo_max_token_len=$((1024 * 2)) # >= 2 * seq_len
infer_ppo_max_token_len=$((1024 * 8)) # >= max_prompt_length + max_response_length (1024 + 1024*2 = 3072)
offload=True
...
exp_name='Qwen3-1.7B-E1_by_r1-DAPO'
