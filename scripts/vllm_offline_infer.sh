...
save_name=results/rl_cold_start/pdtb2/qwen3-1.7b-exp_by_qwen3/epo1/generated_predictions.jsonl
python /data/whsun/LLaMA-Factory/scripts/vllm_infer.py \
    --dataset pdtb2_test_qwen3_max_exp \
    --model_name_or_path expt/rl_cold_start/pdtb2/qwen3-1.7b-exp_by_qwen3/epo1/lora_merged \
